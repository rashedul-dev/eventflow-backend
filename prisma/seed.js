...
async function main() {
    ...
    const hashedPassword = await bcryptjs_1.default.hash("Admin@123456", 12);
    ...
    const event2 = await prisma.event.create({
        data: {
            ...
            description: "Experience the best live music of the summer! Three days of non-stop entertainment with top artists from around the world.",
    ...
    const event3 = await prisma.event.create({
        data: {
            ...
            description: "Hands-on workshop covering the latest in AI and machine learning. Perfect for developers and data scientists.",
    ...
    const event4 = await prisma.event.create({
        data: {
            ...
            postalCode: "10001",
            capacity: 200,
            status: client_1.EventStatus.PENDING_APPROVAL,
            category: "networking",
